...
//        [_playPauseButton setTitle:@"暂停" forState:UIControlStateSelected];
        [_playPauseButton setBackgroundImage:[UIImage imageNamed:@"video_bofang"] forState:UIControlStateNormal];
        [_playPauseButton setBackgroundImage:[UIImage imageNamed:@"video_zanting"] forState:UIControlStateSelected];
...
//        _movieTimeControl.maximumTrackTintColor = [UIColor redColor];
...
//        _fullScreenButton.backgroundColor = [UIColor redColor];
        [_fullScreenButton setBackgroundImage:[UIImage imageNamed:@"full"] forState:UIControlStateNormal];
        [_fullScreenButton setBackgroundImage:[UIImage imageNamed:@"notfull"] forState:UIControlStateSelected];
//        [_fullScreenButton setImage:[UIImage imageNamed:@"notfull.jpg"] forState:UIControlStateNormal];
//        [_fullScreenButton setImage:[UIImage imageNamed:@"full.jpg"] forState:UIControlStateSelected];
//        
